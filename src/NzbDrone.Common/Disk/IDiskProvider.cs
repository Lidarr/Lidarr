...
namespace NzbDrone.Common.Disk
{
    public interface IDiskProvider
    {
        ...
        List<DirectoryInfoBase> GetDirectoryInfos(string path);
        FileInfoBase GetFileInfo(string path);
        List<FileInfoBase> GetFileInfos(string path, SearchOption searchOption = SearchOption.TopDirectoryOnly);
