...
namespace NzbDrone.Common.Disk
{
    public abstract class DiskProviderBase : IDiskProvider
    {
        ...
        protected List<DriveInfoBase> GetDriveInfoMounts()
        {
        ...
        public List<DirectoryInfoBase> GetDirectoryInfos(string path)
        {
            Ensure.That(path, () => path).IsValidPath();
        ...
        public List<FileInfoBase> GetFileInfos(string path, SearchOption searchOption = SearchOption.TopDirectoryOnly)
        {
            Ensure.That(path, () => path).IsValidPath();
