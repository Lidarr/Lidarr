...
namespace NzbDrone.Core.Indexers.Waffles
{
    ...
    public class WafflesSettings : ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(5, Type = FieldType.Number, Label = "Early Release Limit", Unit = "days", HelpText = "Time before album release date a release will be grabbed by Lidarr, empty is no limit.", Advanced = true)]
