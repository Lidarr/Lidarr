...
namespace NzbDrone.Core.Test.TvTests.EpisodeRepositoryTests
{
    ...
    public class EpisodesWhereCutoffUnmetFixture : DbTest<EpisodeRepository, Episode>
    {
        ...
        public void Setup()
        {
            ...
            var qualityMet = new EpisodeFile { RelativePath = "a", Quality = new QualityModel { Quality = Quality.MP3_256 } };
            var qualityUnmet = new EpisodeFile { RelativePath = "b", Quality = new QualityModel { Quality = Quality.MP3_192 } };
