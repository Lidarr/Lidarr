...
namespace NzbDrone.Core.Test.Download.DownloadClientTests.FreeboxDownloadTests
{
    ...
    public class TorrentFreeboxDownloadFixture : DownloadClientFixtureBase<TorrentFreeboxDownload>
    {
        ...
        protected override RemoteAlbum CreateRemoteAlbum()
        {
            ...
            album.Release.DownloadUrl = _downloadURL;
        ...
        public async Task Download_should_queue_torrent_first_as_expected(int ageDay, int olderPriority, int recentPriority, bool toBeQueuedFirstFlag)
        {
            ...
            {
                ReleaseDate = DateTime.UtcNow.Date.AddDays(-ageDay)
            };

            remoteAlbum.Albums.Add(album);
        ...
        public async Task Download_should_define_seed_ratio_as_expected(double? providerSeedRatio, double? expectedSeedRatio)
        {
            ...
            remoteAlbum.SeedConfiguration = new TorrentSeedConfiguration();
            remoteAlbum.SeedConfiguration.Ratio = providerSeedRatio;
