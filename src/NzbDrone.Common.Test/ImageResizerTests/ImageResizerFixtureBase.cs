...
namespace NzbDrone.Common.Test.ImageResizerTests
{
    public abstract class ImageResizerFixtureBase<TSubject> : TestBase<TSubject> where TSubject: class, IImageResizer
    {
        [SetUp]
        public void SetUp()
        {
